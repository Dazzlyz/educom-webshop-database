...
SELECT mhl_suppliers.name, SUM(mhl_hitcount.hitcount) AS 'NUMHITS', COUNT(mhl_hitcount.month) AS 'NUMMONTHS', ROUND(AVG(mhl_hitcount.hitcount))
FROM mhl_hitcount
...
SELECT mhl_suppliers.membertype,
mhl_cities.name AS 'stad', 
